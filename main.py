...
if __name__ == '__main__':
    ...
    # img_gray = img_gray[100:700, 0:500]
    if img_gray is None:
    ...
    # img_gray = add_gaussian_noise(img_gray.copy(), 0.0, 0.3)  # sigma = 0.01 - 0.5
    ...
    show_image(edges, "Non_max", save_image=save_image, use_matplotlib=matplotlib_plotting)

    # 4. Hysteresis Thresholding
    hyst_method_auto = True

    if hyst_method_auto:
        canny_edges = hyst_thresh_auto(edges, 0.02, 0.01)
    else:
        canny_edges = hyst_thresh(edges, 0.2, 0.3)
